...
def conectar():
    """Retorna uma conexão com o banco com foreign keys ativadas."""
    ...
    try:
        with conectar() as con:
            ...
            if not metas:
                ...
                for meta in metas:
                    porcentagem = (meta[1] / meta[2]) * 100 if meta[2] != 0 else 0
                    if porcentagem > 100:
                        porcentagem = 100
...
def atualizar_meta():
    ...
    try:
        ...
        novo_valor = float(input("Novo valor atual: ").strip())
